      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar navbar-dark">
            <li class=""><a href="#">Add Question</a></li>
            <li><a href="#category">Add Category</a></li>
            <li><a href="#delete">Delete Category</a></li>
            <li><a href="#deleteans">Delete Answers</a></li>
          </ul>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" id="delete">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" id="deleteans">
          <h1 class="page-header">Delete Answers</h1>
          ...
          <div class="table-responsive">
			...
			?>
				  ...
				  <form method="post" action="delete_ans.php">
					<div class="form-group">
					  <label for="text">Question name</label>
					  <input type="text" class="form-control" name="ans_d"  placeholder="Enter Name">
					</div>
