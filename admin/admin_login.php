...
button {
    border-radius: 20px;
    border: 1px solid rgba(175, 213, 100, 1);
    background: rgba(175, 213, 100, 1);
    color: #fff;
    font-size: 12px;
    font-weight: bold;
    padding: 12px 45px;
...
.overlay {
    background: rgba(175, 213, 100, 1);
    background: linear-gradient(to right,rgba(175, 213, 100, 1), rgba(175, 213, 100, 1)) no-repeat 0 0 / cover;
    color: #fff;
    position: relative;
    left: -100%;
    height: 100%;
...
<div class="container" id="container">
	...
	<div class="form-container sign-in-container">
		<form role="form" action="admin_sub.php" method="post">
			<h1>Sign in</h1>
			<!-- <div class="social-container">
				<a href="#" class="social"><i class="fab fa-facebook-f"></i></a>
				<a href="#" class="social"><i class="fab fa-google-plus-g"></i></a>
