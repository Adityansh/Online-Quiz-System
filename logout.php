...
<html lang="en">
    ...
    <body>
        ...
        <center>
            <h2>You have successfully have Logged Out</h2>
            <br>
            <img src="https://thumbs.gfycat.com/ImaginativeNeighboringIchneumonfly-size_restricted.gif" width="800px" height="350px">
        </center>
    </body>
</html>
